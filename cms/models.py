...
class CmsSlider(models.Model):
    ...
    cms_text = models.CharField(max_length=200, verbose_name='Текст', default='text')
    cms_css = models.CharField(max_length=200, verbose_name='CSS класс', default='css', null=True)
